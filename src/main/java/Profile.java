...
public class Profile extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\MANDA MANOJ KUMAR\\OneDrive\\Documents\\NetBeansProjects\\WebPharmaManagement\\src\\main\\java\\images\\profile.png")); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(name.equals("")){
            ...
            try{
                 Connection con= ConnectionProvider.getCon();
                PreparedStatement st=con.prepareStatement("update appuser set name=?,mobilenumber=?,email=?,address=? where username=?");
                st.setString(1,name);
